      ...
      <main className="flex-1 overflow-y-auto custom-scrollbar px-6 py-8">
        <div className="space-y-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 relative z-10">
              ...
              <div className="flex-1 space-y-2 text-center md:text-left">
                ...
                <p className="text-white/80 text-xs md:text-sm font-medium">
                  Nhận mạng vô hạn, chặn quảng cáo, và mở khóa lộ trình học đặc
                  quyền.
                </p>
              </div>
            </div>
          ...
          <section className="space-y-4">
            <h3 className="font-headline-md text-lg text-on-surface uppercase tracking-wide">
              Mạng / Trái tim
            </h3>
            <div className="space-y-3">
              ...
              <div className="bg-surface-container rounded-3xl p-5 border-b-4 border-black/20 flex items-center gap-4 shadow-sm">
                ...
                <div className="flex-1">
                  <h4 className="font-body-lg text-sm md:text-base text-on-surface font-bold">
                    Hồi phục Trái tim
                  </h4>
                  <p className="text-on-surface-variant text-xs mt-0.5">
                    Lấp đầy trái tim để tiếp tục các bài học.
                  </p>
                </div>
                {user.hearts >= 5 ? (
                  <button
              ...
              <div className="bg-surface-container rounded-3xl p-5 border-b-4 border-black/20 flex items-center gap-4 shadow-sm">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-on-surface-variant text-xs mt-0.5">
                    Không bao giờ lo lắng về việc hết mạng học tập.
                  </p>
                </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-on-surface-variant text-xs mt-1 leading-relaxed">
                    Streak Freeze cho phép bạn bỏ lỡ một ngày luyện tập mà không
                    bị mất chuỗi hoạt động Streak của mình.
                  </p>
                </div>
              </div>
              <button
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-surface-container rounded-3xl p-5 border-b-4 border-black/20 space-y-4 shadow-md">
            <div className="flex justify-between items-center">
              <h4 className="font-headline-md text-base leading-tight">
                Nhiệm vụ hằng ngày
              </h4>
          ...
          <div className="bg-surface-container rounded-3xl p-5 border-b-4 border-black/20 space-y-4 shadow-md">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="aspect-video bg-white rounded-xl flex items-center justify-center p-2">
                <span className="text-gray-500 font-extrabold text-[10px] tracking-wider uppercase">
                  TECH CORP
                </span>
              </div>
              <div className="aspect-video bg-white rounded-xl flex items-center justify-center p-2">
                <span className="text-emerald-500 font-extrabold text-[10px] tracking-wider uppercase">
                  STUDY GO
                </span>
              </div>
              <div className="aspect-video bg-white rounded-xl flex items-center justify-center p-2">
                <span className="text-orange-500 font-extrabold text-[10px] tracking-wider uppercase">
                  FOCUS HUB
                </span>
              </div>
              <div className="aspect-video bg-white rounded-xl flex items-center justify-center p-2">
                <span className="text-purple-500 font-extrabold text-[10px] tracking-wider uppercase">
                  ZEN GAMES
                </span>
              </div>
            </div>
