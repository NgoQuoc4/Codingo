      ...
      <main className="flex-1 overflow-y-auto custom-scrollbar px-6 py-8">
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          <div className="relative mb-12">
            <div className="h-44 w-full bg-surface-container-high rounded-3xl border-b-4 border-black/20 flex items-center justify-center relative overflow-hidden">
              <div
                ...
                style={{
                  backgroundImage:
                    "radial-gradient(#dfe2f3 1px, transparent 1px)",
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <div className="flex gap-1">
                ...
                <span className="px-2 py-0.5 bg-secondary/10 text-secondary text-[10px] font-black rounded-lg border border-secondary/20">
                  💻
                </span>
                <span className="px-2 py-0.5 bg-tertiary/10 text-tertiary text-[10px] font-black rounded-lg border border-tertiary/20">
                  👑
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 text-on-surface-variant text-xs font-bold flex-wrap pt-1">
              ...
              <div className="flex gap-3">
                <span className="hover:underline cursor-pointer">
                  <strong className="text-on-surface font-black">0</strong> Đang
                  theo dõi
                </span>
                <span className="hover:underline cursor-pointer">
                  <strong className="text-on-surface font-black">0</strong>{" "}
                  Người theo dõi
                </span>
              </div>
            </div>
          ...
          <section className="space-y-4">
            <h3 className="font-headline-md text-base md:text-lg">
              Thống kê tiến độ
            </h3>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-surface-container p-4 rounded-3xl border-2 border-outline-variant/30 flex items-center gap-3 relative overflow-hidden">
                ...
                <div>
                  ...
                  <p className="font-label-lg text-on-surface-variant/60 uppercase tracking-wide text-[10px]">
                    Ngày streak
                  </p>
                </div>
              </div>
          ...
          {/* Biểu đồ XP 7 ngày gần nhất */}
          <XpHistoryChart xpHistory={user.xpHistory} />
            ...
            <div className="space-y-4">
              ...
              <div className="bg-surface-container p-5 rounded-3xl border-2 border-outline-variant/30 flex items-center gap-4 shadow-sm">
                ...
                <div className="flex-grow min-w-0">
                  ...
                  <p className="text-[11px] text-on-surface-variant/70 mt-1.5">
                    Đạt chuỗi 75 ngày streak liên tục
                  </p>
                </div>
              </div>
              ...
              <div className="bg-surface-container p-5 rounded-3xl border-2 border-outline-variant/30 flex items-center gap-4 shadow-sm">
                ...
                <div className="flex-grow min-w-0">
                  ...
                  <p className="text-[11px] text-on-surface-variant/70 mt-1.5">
                    Tích lũy tổng điểm kinh nghiệm đạt 7500 XP
                  </p>
                </div>
              </div>
            </div>
